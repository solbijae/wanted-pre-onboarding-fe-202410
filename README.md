...
### Demo
<p align="center">
  <img src="https://github.com/user-attachments/assets/4e9977bb-fb21-4051-81a1-42c6804614b6" alt="Demo" width="50%">
</p>

### Assignment
Implement infinite scrolling on a single page using Intersection Observer.

Display the total sum of the prices of the currently fetched product list on the screen (e.g., if 20 products are presently fetched, show the total sum of the prices of those 20 products).

Conditions for Infinite Scrolling:
- When the user scrolls to the bottom of the currently displayed page, fetch the next information page.
- If there is no more data to fetch, stop calling the function to fetch additional data.
- Show a loading UI while fetching data (format can be decided freely).

Notes for the Assignment:
- Use React and functional components
- You are allowed to modify the provided mock data.
- Any libraries related to infinite scrolling are NOT allowed.
- Any asynchronous state management libraries are NOT allowed (e.g., tanstack-query).
- You may use other libraries outside of points 3 and 4 freely.
